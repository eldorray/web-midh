                ...
                <div class="container-default">
                    <div class="breadcrumb-block">
                        ...
                        <ul class="breadcrumb-nav">
                            <li><a href="/">Home</a></li>
                            <li><a href="/ppdb">Cek Pendaftaran</a></li>
                            <li>Form PPDB Online</li>
                        </ul>
                    </div>
                </div>

                <div class="absolute left-0 top-0 -z-10">
                    <img src="{{ asset('assets/img/elements/breadcrumb-shape-1.svg') }}" alt="hero-shape-1"
                        width="291" height="380" />
                </div>

                <div class="absolute bottom-0 right-0 -z-[1]">
                    <img src="{{ asset('assets/img/elements/breadcrumb-shape-2.svg') }}" alt="hero-shape-2"
                        width="291" height="380" />
                </div>
            </div>
        </section>
                ...
                <div class="container-default">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <div class="text-center mb-8">
                            <h1 class="text-3xl font-bold text-gray-800 mb-2">Form Pendaftaran PPDB</h1>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <input type="text" id="nama_lengkap" name="nama_lengkap"
                                                ...
                                                value="{{ old('nama_lengkap') }}" placeholder="Sesuai akta kelahiran"
                                                required>
                                            @error('nama_lengkap')
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <textarea id="alamat_lengkap" name="alamat_lengkap" rows="3"
                                                ...
                                                placeholder="Jalan, RT/RW, Kelurahan, Kecamatan, Kota, Kode Pos" required>{{ old('alamat_lengkap') }}</textarea>
                                        ...
                                        <div>
                                            ...
                                            <select id="status_keluarga" name="status_keluarga"
                                                ...
                                                required>
                                                <option value="">-- Pilih --</option>
                                                <option value="Anak kandung" @selected(old('status_keluarga') == 'Anak kandung')>Anak kandung
                                                </option>
                                                <option value="Anak angkat" @selected(old('status_keluarga') == 'Anak angkat')>Anak angkat
                                                </option>
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <select id="kewarganegaraan" name="kewarganegaraan"
                                                ...
                                                required>
                                                <option value="">-- Pilih --</option>
                                                <option value="Indonesia" @selected(old('kewarganegaraan') == 'Indonesia')>Indonesia
                                                </option>
                                                <option value="Asing" @selected(old('kewarganegaraan') == 'Asing')>Asing</option>
                                            </select>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="nik_ayah" name="nik_ayah"
                                                    ...
                                                    value="{{ old('nik_ayah') }}" placeholder="16 digit NIK"
                                            ...
                                            <div>
                                                ...
                                                <select id="pendidikan_ayah" name="pendidikan_ayah"
                                                    ...
                                                    required>
                                                    <option value="">-- Pilih --</option>
                                                    <option value="SD/Tidak Sekolah" @selected(old('pendidikan_ayah') == 'SD/Tidak Sekolah')>
                                                        SD/Tidak Sekolah</option>
                                                    <option value="SMP" @selected(old('pendidikan_ayah') == 'SMP')>SMP</option>
                                                    <option value="SMA/SMK" @selected(old('pendidikan_ayah') == 'SMA/SMK')>SMA/SMK
                                                    </option>
                                                    <option value="Diploma" @selected(old('pendidikan_ayah') == 'Diploma')>Diploma
                                                    </option>
                                                    <option value="Sarjana" @selected(old('pendidikan_ayah') == 'Sarjana')>Sarjana
                                                    </option>
                                                    <option value="Magister" @selected(old('pendidikan_ayah') == 'Magister')>Magister
                                                    </option>
                                                </select>
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <select id="penghasilan_ayah" name="penghasilan_ayah"
                                                    ...
                                                    required>
                                                    <option value="">-- Pilih --</option>
                                                    <option value="< Rp 500.000" @selected(old('penghasilan_ayah') == '< Rp 500.000')>&lt; Rp
                                                        500.000</option>
                                                    <option value="Rp 500.000 - Rp 1.000.000"
                                                        @selected(old('penghasilan_ayah') == 'Rp 500.000 - Rp 1.000.000')>Rp 500.000 - Rp 1.000.000</option>
                                                    <option value="Rp 1.000.000 - Rp 2.000.000"
                                                        @selected(old('penghasilan_ayah') == 'Rp 1.000.000 - Rp 2.000.000')>Rp 1.000.000 - Rp 2.000.000
                                                    </option>
                                                    <option value="Rp 2.000.000 - Rp 3.000.000"
                                                        @selected(old('penghasilan_ayah') == 'Rp 2.000.000 - Rp 3.000.000')>Rp 2.000.000 - Rp 3.000.000
                                                    </option>
                                                    <option value="> Rp 3.000.000" @selected(old('penghasilan_ayah') == '> Rp 3.000.000')>&gt;
                                                        Rp 3.000.000</option>
                                                </select>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="nik_ibu" name="nik_ibu"
                                                    ...
                                                    value="{{ old('nik_ibu') }}" placeholder="16 digit NIK"
                                                    maxlength="16" inputmode="numeric" required>
                                                @error('nik_ibu')
                                                    <span
                                                        class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                                            ...
                                            <div>
                                                ...
                                                <select id="pendidikan_ibu" name="pendidikan_ibu"
                                                    ...
                                                    required>
                                                    <option value="">-- Pilih --</option>
                                                    <option value="SD/Tidak Sekolah" @selected(old('pendidikan_ibu') == 'SD/Tidak Sekolah')>
                                                        SD/Tidak Sekolah</option>
                                                    <option value="SMP" @selected(old('pendidikan_ibu') == 'SMP')>SMP</option>
                                                    <option value="SMA/SMK" @selected(old('pendidikan_ibu') == 'SMA/SMK')>SMA/SMK
                                                    </option>
                                                    <option value="Diploma" @selected(old('pendidikan_ibu') == 'Diploma')>Diploma
                                                    </option>
                                                    <option value="Sarjana" @selected(old('pendidikan_ibu') == 'Sarjana')>Sarjana
                                                    </option>
                                                    <option value="Magister" @selected(old('pendidikan_ibu') == 'Magister')>Magister
                                                    </option>
                                                </select>
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <select id="penghasilan_ibu" name="penghasilan_ibu"
                                                    ...
                                                    required>
                                                    <option value="">-- Pilih --</option>
                                                    <option value="< Rp 500.000" @selected(old('penghasilan_ibu') == '< Rp 500.000')>&lt; Rp
                                                        500.000</option>
                                                    <option value="Rp 500.000 - Rp 1.000.000"
                                                        @selected(old('penghasilan_ibu') == 'Rp 500.000 - Rp 1.000.000')>Rp 500.000 - Rp 1.000.000</option>
                                                    <option value="Rp 1.000.000 - Rp 2.000.000"
                                                        @selected(old('penghasilan_ibu') == 'Rp 1.000.000 - Rp 2.000.000')>Rp 1.000.000 - Rp 2.000.000
                                                    </option>
                                                    <option value="Rp 2.000.000 - Rp 3.000.000"
                                                        @selected(old('penghasilan_ibu') == 'Rp 2.000.000 - Rp 3.000.000')>Rp 2.000.000 - Rp 3.000.000
                                                    </option>
                                                    <option value="> Rp 3.000.000" @selected(old('penghasilan_ibu') == '> Rp 3.000.000')>&gt;
                                                        Rp 3.000.000</option>
                                                </select>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input type="tel" id="nomor_telepon" name="nomor_telepon"
                                                ...
                                                value="{{ old('nomor_telepon') }}" placeholder="08123456789"
                                                required>
                                            @error('nomor_telepon')
                                                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div
                                            ...
                                            <label for="akta_kelahiran" class="block cursor-pointer">
                                                ...
                                                <input type="file" id="akta_kelahiran" name="akta_kelahiran"
                                                    class="hidden" accept=".pdf,.jpg,.jpeg,.png" required
                                        ...
                                        <div
                                            ...
                                            <label for="kartu_keluarga" class="block cursor-pointer">
                                                <div class="text-center">
                                                    ...
                                                    <p class="mt-2 text-sm font-medium text-gray-700">
                                                        Scan Kartu Keluarga <span class="text-red-500">*</span>
                                                    </p>
                                                    <p class="mt-1 text-xs text-gray-500">PDF, JPG, PNG (Max 2MB)</p>
                                                </div>
