            ...
            <div class="breadcrumb-wrapper">
                <div class="container-default">
                    <div class="breadcrumb-block">
                        <h1 class="breadcrumb-title">Edit Pendaftaran</h1>
                        <ul class="breadcrumb-nav">
                            <li><a href="/">Home</a></li>
                            <li><a href="/registration">Cek Pendaftaran</a></li>
                            <li>Edit Form Pendaftaran</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="container-default">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-8">
                            <form action="{{ route('ppdb.update', $registration->id) }}" method="POST"
