                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('blog.update', $blog->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @php
                                $currentThumbnailUrl = $blog->thumbnail
                                    ? \Illuminate\Support\Facades\Storage::url($blog->thumbnail)
                                    : '';
                            @endphp

                            <div class="mt-2">
                                <img id="thumbnail-preview" src="{{ $currentThumbnailUrl }}"
                                    data-current="{{ $currentThumbnailUrl }}" alt="Thumbnail preview"
                                    class="{{ $currentThumbnailUrl ? '' : 'hidden' }} max-h-48 rounded border" />
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-trix-input id="content" name="content" value="{!! $blog->content !!}" />
                            @error('content')
