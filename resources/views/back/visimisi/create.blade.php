                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('visiMisi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="visi" id="visi" value="{{ old('visi') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <x-trix-input id="misi" name="misi" value="{{ old('misi') }}" />
                            @error('misi')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-trix-input id="tujuan" name="tujuan" />
                            @error('tujuan')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="sejarah" id="sejarah"
                                class="mt-1 block w-full border @error('sejarah') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"></textarea>
                            @error('sejarah')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
