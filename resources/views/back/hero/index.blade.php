                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-2">Small Text</th>
                            ...
                            <tbody>
                                @foreach ($heroes as $hero)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">{{ $hero->title }}</td>
                                        <td class="px-4 py-2">{{ $hero->description }}</td>
                                        <td class="px-4 py-2">{{ $hero->small_text }}</td>
                                        <td class="px-4 py-2">
                                            @if ($hero->image)
                                        ...
                                        <td class="px-4 py-2">{{ $hero->is_active ? 'Yes' : 'No' }}</td>
                                        <td class="px-4 py-2">
